...
def detect(opt):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            Path(str(save_dir / 'labels' / p.stem)).mkdir(parents=True, exist_ok=True)
            ...
            if len(det):
                ...
                for det_index, (*xyxy, conf, cls) in enumerate(reversed(det[:,:6])):
                    if save_txt:  # Write to file
                        ...
                        line = (dataset.frame, -1, cls, *xyxy)  # format for MOT datset 0313
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img-size', nargs= '+', type=int, default=1920, help='inference size (pixels)')
